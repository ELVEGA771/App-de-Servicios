...
SELECT 
    ...
    p.estado_pago,
    cal.calificacion,
    cal.comentario AS calificacion_comentario,
    s.id_empresa -- Added for filtering
...
LEFT JOIN pago p ON con.id_contratacion = p.id_contratacion
LEFT JOIN calificacion cal ON con.id_contratacion = cal.id_contratacion;
